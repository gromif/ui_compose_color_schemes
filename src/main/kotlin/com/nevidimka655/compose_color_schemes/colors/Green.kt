...
private object Green {
    val md_theme_light_primary = Color(0xFF436915)
    val md_theme_light_onPrimary = Color(0xFFFFFFFF)
    val md_theme_light_primaryContainer = Color(0xFFC2F18D)
    ...
    val md_theme_dark_onPrimaryContainer = Color(0xFFC2F18D)
...
val _ColorSchemes.colors.green get() = _ColorSchemes.autoScheme(
    lightScheme = Green.LightColors,
    darkScheme = Green.DarkColors
)
